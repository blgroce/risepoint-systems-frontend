    ...
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 bg-subtle-pattern">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute top-32 left-16 w-40 h-40 bg-teal-100/15 rounded-full blur-2xl"></div>
          <div className="absolute bottom-28 right-24 w-28 h-28 bg-purple-100/15 rounded-full blur-xl"></div>
        </div>
